<div class="relative items-center w-full h-full px-4 text-white !bg-center !bg-no-repeat !bg-cover md:px-24 drop-shadow-lg"
    style="background-image: url('{{ asset('images/hero.png') }}')
>
    <div class="grid grid-cols-1 py-8 mx-auto
    md:grid-cols-2 max-w-screen-theme-screen">
